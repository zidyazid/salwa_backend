            ...
            <table class="table table-bordered w-100">
                ...
                @foreach ($item->details as $itemDetail)
                    <tr>
                        ...
                        <td>{{ $itemDetail->product->type }}</td>
                        <td>Rp.{{ $itemDetail->product->price }}</td>
                    </tr>
                @endforeach
                <tr>
                </tr>
